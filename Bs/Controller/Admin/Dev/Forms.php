...
class Forms extends \Bs\Controller\AdminIface
{
    ...
    {
        //return $this->getConfig()->createForm($id);
        $form = $this->getConfig()->createForm($id);
//        $renderer = \Tk\Form\Renderer\DomRenderer::create($form);
//        $form->setRenderer($renderer);
//        $renderer->setFieldGroupRenderer($this->getConfig()->getFormFieldGroupRenderer($form));
//        $renderer->getLayout()->setDefaultCol('col');
        return $form;
    }
    ...
    public function doDefault(\Tk\Request $request)
    {
        ...
        ///
        $this->form3 = $this->createForm('form3');
