...
class User
{
	...
	public static function sendRegister(\Bs\Db\User $user): bool
    {
	...
	public static function sendRecovery(\Bs\Db\User $user): bool
    {
        $config = Config::instance();
        ...
        $hashToken = Encrypt::create($config->get('system.encrypt'))->encrypt(serialize(['h' => $user->getHash(), 't' => time()]));
